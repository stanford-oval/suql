...
def parse_execute_sql(dlgHistory, user_query, prompt_file='prompts/parser_suql.prompt'):
    ...
    """
    generated_suql, generated_sql_time = llm_generate(template_file=prompt_file,
    ...
    final_res, column_names, cache = suql_execute(postprocessed_suql, fts_fields=[("restaurants", "name")])
    ...
    return final_res, generated_suql, postprocessed_suql, generated_sql_time, suql_execute_end_time - suql_execute_start_time, cache, results_for_ned
